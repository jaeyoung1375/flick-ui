              ...
              {options.map((opt) => (
                <RadixSelect.Item
                  ...
                  className={cn(
                    ...
                    "hover:bg-motive-soft hover:text-motive",
                    "focus:outline-none focus:bg-motive-soft focus:text-motive",
                    "data-[highlighted]:bg-motive-soft data-[highlighted]:text-motive",
                    "data-[state=checked]:font-semibold",
                  )}
                >
                  <RadixSelect.ItemText>{opt.label}</RadixSelect.ItemText>
                  <RadixSelect.ItemIndicator>
                    <Check className="w-3.5 h-3.5 text-motive" />
                  </RadixSelect.ItemIndicator>
                </RadixSelect.Item>
              ))}
