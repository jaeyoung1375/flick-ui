...
const variantClasses: Record<Variant, string> = {
  primary:
    "bg-motive text-white hover:bg-motive-hover active:bg-motive-pressed",
  dark: "bg-ink-900 text-white hover:bg-ink-800",
  outlined:
    "bg-transparent text-motive border border-motive hover:bg-motive-soft",
  neutral:
    "bg-transparent text-ink-700 border border-ink-200 hover:border-motive hover:text-motive hover:bg-motive-soft",
  ghost: "bg-transparent text-motive hover:bg-motive-soft",
};
