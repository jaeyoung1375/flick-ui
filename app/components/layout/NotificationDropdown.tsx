  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -right-0.5 -top-0.5 flex min-h-4 min-w-4 items-center justify-center rounded-full bg-motive px-1 text-[10px] font-bold leading-4 text-white">
                ...
                return (
                  ...
                  >
                    <span className="mt-1 flex h-2 w-2 shrink-0 items-center justify-center">
                      {!isRead && (
                        <span className="h-2 w-2 rounded-full bg-motive" />
                      )}
                    </span>
