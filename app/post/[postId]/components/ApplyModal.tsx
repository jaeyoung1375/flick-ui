        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 flex flex-col gap-6">
          ...
          <section>
            <div className="flex items-center gap-2 mb-3">
              <Briefcase size={15} className="text-motive" />
              <span className="text-[14px] font-bold text-ink-800">
                지원 포지션
                <span className="text-motive ml-0.5">*</span>
              </span>
            </div>
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    selectedPosition === pos.code
                      ? "bg-motive text-white border-motive shadow-sm"
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    selectedTechStacks.includes(tech)
                      ...
                      : "bg-ink-50 text-ink-500 border-ink-200 hover:border-motive hover:text-motive",
                  )}
                >
                  {tech}
                </button>
          ...
          <section>
            <div className="flex items-center gap-2 mb-3">
              <FileText size={15} className="text-motive" />
              <span className="text-[14px] font-bold text-ink-800">
                지원 동기
                <span className="text-motive ml-0.5">*</span>
              </span>
          ...
          <section>
            <div className="flex items-center gap-2 mb-3">
              <Link size={15} className="text-motive" />
              <span className="text-[14px] font-bold text-ink-800">
                포트폴리오 URL
                <span className="text-[12px] text-ink-400 font-normal ml-1.5">
                  (선택 · GitHub, Notion 등)
