            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="bg-white rounded-[16px] border border-ink-200/70 p-6">
                ...
                <div className="flex flex-wrap gap-4 text-[13px] text-ink-500 font-medium">
                  ...
                  <span className="flex items-center gap-1.5 text-motive font-bold">
                    <Calendar size={13} />
              ...
              <div className="bg-white rounded-[16px] border border-ink-200/70 p-6">
                ...
                <ul className="flex flex-col gap-2">
                  {/* {memoData.recruitTarget.map((target, i) => (
                    ...
                    >
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-motive shrink-0" />
                      {target}
                    </li>
                  ))} */}
                  <li
                    ...
                    <div key={user.name} className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <div className="flex items-center gap-2">
                          ...
                          {user.isLeader && (
                            <span className="text-[11px] font-bold text-motive bg-motive-soft px-2 py-0.5 rounded-[5px]">
                              리더
                            </span>
                          )}
                        </div>
              ...
              <div className="bg-white rounded-[16px] border border-ink-200/70 p-5">
                {!user ? (
                  ...
                  <>
                    ...
                    <p className="text-[13px] text-motive mt-0.5 mb-4">
                      {memoData.isDeadlineOver ? (
                        "마감되었습니다"
                      ) : (
                      ...
                      <>
                        ...
                        <button
                          ...
                          className={clsx(
                            ...
                            bookmarked
                              ? "bg-motive-soft text-motive border-motive"
                              : "bg-transparent text-ink-700 border-ink-200 hover:border-motive hover:text-motive hover:bg-motive-soft",
                          )}
                        >
